# Dokumentasi Jaringan Retail SiKouta

README ini menjelaskan modul jaringan retail pada aplikasi SiKouta, mulai dari role, struktur downline, komisi, withdraw, endpoint, sampai tabel database yang dipakai.
...
- `sikouta-fe/components/user/RetailDownlineManager.tsx`
- `sikouta-fe/components/user/RetailCommissionClient.tsx`
- `sikouta-fe/components/user/RetailWithdrawClient.tsx`
- `sikouta-fe/components/dashboard/RetailWithdrawRequestsPage.tsx`
- `sikouta-fe/lib/memberRoles.ts`
