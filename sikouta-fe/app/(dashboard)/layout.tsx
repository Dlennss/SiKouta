...
export default function DashboardGroupLayout({ children }: { children: ReactNode }) {
  ...
  if (!ready) {
    return (
      <div className="grid min-h-screen place-items-center bg-[#EFFBFF] p-6">
        <div className="w-full max-w-sm rounded-[28px] border border-sky-100 bg-white p-5 shadow-[0_24px_60px_rgba(22,138,242,0.12)]">
          <div className="h-5 w-32 animate-pulse rounded-full bg-sky-100" />
          <div className="mt-4 h-10 animate-pulse rounded-2xl bg-sky-50" />
  ...
  return (
    <div className="min-h-screen bg-[#EFFBFF] text-slate-950">
