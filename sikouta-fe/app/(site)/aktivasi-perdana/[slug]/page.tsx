...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | SiKouta",
      description: "Pilih produk aktivasi perdana operator di SiKouta.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | SiKouta`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di SiKouta. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di SiKouta dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
    keywords: [`aktivasi perdana ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} perdana`, "sikouta"],
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | SiKouta`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di SiKouta dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di SiKouta tersedia lengkap?`,
      answer: `Ya. SiKouta menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di SiKouta?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member SiKouta untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
