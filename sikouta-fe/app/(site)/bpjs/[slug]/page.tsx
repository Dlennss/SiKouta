...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (slug !== "kesehatan" && slug !== "ketenagakerjaan") {
    return buildPageMetadata({
      title: "BPJS | SiKouta",
      description: "Cek dan bayar BPJS di SiKouta.",
      path: "/bpjs",
    });
  }
  ...
  return buildPageMetadata({
    title: `${title} | SiKouta`,
    description: `Cek dan bayar ${title} di SiKouta dengan alur yang ringkas.`,
    path: `/bpjs/${slug}`,
    keywords: [title.toLowerCase(), "bayar bpjs", "sikouta"],
  });
}
