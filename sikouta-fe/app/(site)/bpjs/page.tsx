...
export const metadata: Metadata = buildPageMetadata({
  title: "BPJS | SiKouta",
  description: "Cek dan bayar BPJS Kesehatan dan BPJS Ketenagakerjaan di SiKouta dengan alur yang ringkas.",
  path: "/bpjs",
  keywords: ["bpjs kesehatan", "bpjs ketenagakerjaan", "bayar bpjs", "sikouta"],
});
