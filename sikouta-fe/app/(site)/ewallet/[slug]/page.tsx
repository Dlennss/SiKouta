...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up E-Wallet | SiKouta",
      description: "Top up e-wallet favorit Anda di SiKouta.",
      path: "/ewallet",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Online | SiKouta`,
    description: lowestPrice
      ? `Top up ${brandTitle} online di SiKouta dengan nominal tetap dan bebas nominal. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Top up ${brandTitle} di SiKouta dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} sikouta`, "ewallet"],
...
export default async function EwalletBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Online | SiKouta`,
    description: `Top up ${brandTitle} di SiKouta dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di SiKouta bisa pilih nominal tetap dan bebas nominal?`,
      answer: `Ya. SiKouta menampilkan produk ${brandTitle} yang aktif, termasuk nominal tetap dan varian bebas nominal bila tersedia.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dipakai untuk kebutuhan top up pribadi maupun penjualan ulang oleh member SiKouta.`,
    },
  ]);
