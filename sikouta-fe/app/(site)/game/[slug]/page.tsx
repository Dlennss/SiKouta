...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up Game Online | SiKouta",
      description: "Top up game online favorit Anda di SiKouta.",
      path: "/game",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Murah | SiKouta`,
    description: lowestPrice
      ? `Top up ${brandTitle} di SiKouta dengan pilihan nominal aktif. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Top up ${brandTitle} di SiKouta dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} murah`, "voucher game", "sikouta"],
...
export default async function GameBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Murah | SiKouta`,
    description: `Top up ${brandTitle} di SiKouta dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di SiKouta tersedia dalam banyak pilihan nominal?`,
      answer: `Ya. SiKouta menampilkan produk ${brandTitle} yang aktif agar pembeli bisa memilih nominal yang sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara top up ${brandTitle} di SiKouta?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member SiKouta untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
