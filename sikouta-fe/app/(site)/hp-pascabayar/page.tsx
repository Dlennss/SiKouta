...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Cek dan bayar tagihan HP pascabayar di SiKouta dengan pilihan operator yang jelas.",
  path: "/hp-pascabayar",
  keywords: ["hp pascabayar", "bayar tagihan hp", "tagihan telepon seluler", "sikouta"],
});
