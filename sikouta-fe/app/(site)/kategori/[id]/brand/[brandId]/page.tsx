...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} SiKouta`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di SiKouta.`,
    path: `/kategori/${id}/brand/${brandId}`,
    keywords: [String(brand).toLowerCase(), String(categoryName).toLowerCase(), "sikouta"],
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} SiKouta`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di SiKouta.`,
    path: `/kategori/${id}/brand/${brandId}`,
