...
export const metadata: Metadata = buildPageMetadata({
  title: "Semua Kategori Produk | SiKouta",
  description: "Lihat semua kategori produk SiKouta, mulai dari pulsa, paket data, e-wallet, game, sampai tagihan.",
  path: "/kategori",
  keywords: ["kategori produk sikouta", "semua produk", "sikouta"],
});
