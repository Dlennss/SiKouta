...
export const metadata: Metadata = buildPageMetadata({
  title: "Tagihan Listrik PLN | SiKouta",
  description: "Bayar tagihan listrik PLN di SiKouta dengan alur yang ringkas untuk pelanggan rumah tangga dan agen.",
  path: "/listrik/tagihan",
  keywords: ["tagihan listrik", "bayar listrik", "pln pascabayar", "sikouta listrik"],
});
