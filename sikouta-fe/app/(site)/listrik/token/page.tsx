...
export const metadata: Metadata = buildPageMetadata({
  title: "Token Listrik PLN | SiKouta",
  description: "Beli token listrik PLN di SiKouta dengan pilihan nominal dan grup produk yang lebih jelas.",
  path: "/listrik/token",
  keywords: ["token listrik", "token pln", "beli token listrik", "sikouta listrik"],
