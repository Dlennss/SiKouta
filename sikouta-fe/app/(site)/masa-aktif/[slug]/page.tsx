...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Masa Aktif Semua Operator | SiKouta",
      description: "Perpanjang masa aktif nomor Anda di SiKouta.",
      path: "/masa-aktif",
    });
  }
  ...
  return buildPageMetadata({
    title: `Perpanjang Masa Aktif ${brandTitle} | SiKouta`,
    description: lowestPrice
      ? `Perpanjang masa aktif ${brandTitle} di SiKouta. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Perpanjang masa aktif ${brandTitle} di SiKouta dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
    keywords: [`masa aktif ${brand.nama.toLowerCase()}`, `perpanjang masa aktif ${brand.nama.toLowerCase()}`, "sikouta"],
...
export default async function MasaAktifBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Perpanjang Masa Aktif ${brandTitle} | SiKouta`,
    description: `Perpanjang masa aktif ${brandTitle} di SiKouta dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah masa aktif ${brandTitle} di SiKouta tersedia dalam beberapa pilihan?`,
      answer: `Ya. SiKouta menampilkan produk masa aktif ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara memperpanjang masa aktif ${brandTitle} di SiKouta?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member SiKouta untuk kebutuhan pribadi dan penjualan ulang.`,
    },
  ]);
