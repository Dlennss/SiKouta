...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!dataCategory) {
    return buildPageMetadata({
      title: "Paket Data Operator | SiKouta",
      description: "Beli paket data operator favorit Anda di SiKouta.",
      path: "/paket-data",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Data ${brandTitle} Murah | SiKouta`,
    description: lowestPrice
      ? `Beli paket data ${brandTitle} di SiKouta dengan pilihan kuota aktif. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Beli paket data ${brandTitle} di SiKouta dengan pilihan kuota dan masa aktif yang jelas.`,
    path: `/paket-data/${slug}`,
    keywords: [`paket data ${brand.nama.toLowerCase()}`, `kuota ${brand.nama.toLowerCase()}`, "sikouta"],
...
export default async function GuestPaketDataBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Data ${brandTitle} Murah | SiKouta`,
    description: `Beli paket data ${brandTitle} di SiKouta dengan pilihan kuota dan masa aktif yang jelas.`,
    path: `/paket-data/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket data ${brandTitle} di SiKouta tersedia dalam banyak pilihan kuota?`,
      answer: `Ya. SiKouta menampilkan paket data ${brandTitle} yang aktif dengan pilihan kuota, masa aktif, dan grup produk yang lebih jelas.`,
    },
    {
      question: `Bagaimana cara beli paket data ${brandTitle} di SiKouta?`,
    ...
    },
    {
      ...
      answer: `Halaman ini bisa dipakai pembeli umum maupun member SiKouta untuk kebutuhan transaksi harian dan penjualan ulang.`,
    },
  ]);
