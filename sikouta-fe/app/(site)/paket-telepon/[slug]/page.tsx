...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!phoneCategory) {
    return buildPageMetadata({
      title: "Paket Telepon Semua Operator | SiKouta",
      description: "Pilih paket telepon operator di SiKouta.",
      path: "/paket-telepon",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Telepon ${brandTitle} | SiKouta`,
    description: lowestPrice
      ? `Pilih paket telepon ${brandTitle} di SiKouta. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih paket telepon ${brandTitle} di SiKouta dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
    keywords: [`paket telepon ${brand.nama.toLowerCase()}`, `nelpon ${brand.nama.toLowerCase()}`, "sikouta"],
...
export default async function GuestPaketTeleponBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Telepon ${brandTitle} | SiKouta`,
    description: `Pilih paket telepon ${brandTitle} di SiKouta dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket telepon ${brandTitle} di SiKouta tersedia dalam banyak pilihan?`,
      answer: `Ya. SiKouta menampilkan paket telepon ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli paket telepon ${brandTitle} di SiKouta?`,
