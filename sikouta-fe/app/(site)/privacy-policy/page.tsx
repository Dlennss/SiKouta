...
const pageTitle = "Privacy Policy SiKouta | Website and Android App";
const pageDescription =
  "Privacy policy for SiKouta website and Android application, including account data, transactions, security, and Google sign-in usage.";
