...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa dan Paket Data | SiKouta",
  description: "Jelajahi pulsa dan paket data semua operator di SiKouta dalam satu halaman yang ringkas.",
  path: "/pulsa-data",
  keywords: ["pulsa dan paket data", "pulsa online", "paket data operator", "sikouta"],
});
