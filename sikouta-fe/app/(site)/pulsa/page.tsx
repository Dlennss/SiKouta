...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa Semua Operator | SiKouta",
  description: "Isi pulsa Telkomsel, Indosat, XL, Axis, Smartfren, dan operator lain di SiKouta dengan pilihan nominal yang jelas dan transaksi cepat.",
  path: "/pulsa",
  keywords: ["pulsa semua operator", "isi pulsa online", "pulsa telkomsel", "pulsa indosat", "sikouta"],
});
