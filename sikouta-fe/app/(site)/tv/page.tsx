...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Beli paket atau bayar layanan TV berlangganan di SiKouta dengan pilihan brand yang jelas.",
  path: "/tv",
  keywords: ["tv berlangganan", "bayar tv online", "voucher tv", "sikouta"],
});
