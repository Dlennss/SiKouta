...
const DEFAULT_SHORTCUTS = [
  ...
  { href: "/user/listrik", label: "Listrik PLN", visualName: "listrik pln" },
  { href: "/user/ewallet", label: "E-Wallet", visualName: "e-money" },
  { href: "/user/kategori", label: "Telpon", visualName: "telepon" },
  { href: "/user/kategori", label: "SMS", visualName: "sms" },
  { href: "/user/kategori", label: "TV Kabel", visualName: "tv kabel" },
...
export function UserCategoryGrid({ items, showAll = false }: UserCategoryGridProps) {
  ...
  return (
    <section>
      <div>
        <div className={showAll ? "grid grid-cols-3 gap-4" : "grid grid-cols-4 gap-x-2 gap-y-4"}>
          {!showAll
