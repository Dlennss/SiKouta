...
function buildGuestIdentity(dest: string) {
  ...
  return {
    guestNama: "Guest SiKouta",
    guestEmail: phone ? `guest-${phone}@sikouta.local` : "guest@sikouta.local",
    guestPhone: phone,
  };
}
...
export function UserCheckoutModal({
  ...
  function handleDownloadProof() {
    void (async () => {
      ...
      doc.setFontSize(11);
      doc.text("SiKouta - QRIS Payment Receipt", centerX, 61, { align: "center" });
      doc.setFontSize(10);
      ...
      doc.setFont("helvetica", "normal");
      doc.text("Dokumen ini dibuat otomatis oleh sistem SiKouta dan valid sebagai bukti pembayaran.", 56, finalY + 58);
