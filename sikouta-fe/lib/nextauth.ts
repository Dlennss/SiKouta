...
const apiBase = () => process.env.NEXT_PUBLIC_API_BASE || process.env.API_BASE || "http://127.0.0.1:8091";
...
export const authOptions: NextAuthOptions = {
  cookies: {
    sessionToken: { name: "sikouta.session-token", options: { httpOnly: true, sameSite: "lax", path: "/", secure: process.env.NODE_ENV === "production" } },
    csrfToken: { name: "sikouta.csrf-token", options: { httpOnly: true, sameSite: "lax", path: "/", secure: process.env.NODE_ENV === "production" } },
    callbackUrl: { name: "sikouta.callback-url", options: { httpOnly: false, sameSite: "lax", path: "/", secure: process.env.NODE_ENV === "production" } },
    state: { name: "sikouta.state", options: { httpOnly: true, sameSite: "lax", path: "/", secure: process.env.NODE_ENV === "production", maxAge: 900 } },
    pkceCodeVerifier: { name: "sikouta.pkce.code_verifier", options: { httpOnly: true, sameSite: "lax", path: "/", secure: process.env.NODE_ENV === "production", maxAge: 900 } },
    nonce: { name: "sikouta.nonce", options: { httpOnly: true, sameSite: "lax", path: "/", secure: process.env.NODE_ENV === "production" } },
  },
