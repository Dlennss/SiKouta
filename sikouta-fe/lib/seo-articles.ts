...
export const CANONICAL_SITE_URL = "https://sikouta.local";
export const DEFAULT_OG_IMAGE_URL = `${CANONICAL_SITE_URL}/brand/logo.svg`;
...
export const seoArticles: SeoArticle[] = [
  {
    ...
    description: "Panduan isi pulsa online Telkomsel, Indosat, XL, Axis, Smartfren, dan Tri lewat SiKouta dengan alur yang cepat dan mudah dipahami.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "SiKouta cocok untuk kebutuhan ini karena pengguna bisa langsung masuk ke kategori pulsa tanpa harus melewati langkah yang rumit.",
        ],
      },
      {
        heading: "Langkah isi pulsa di SiKouta",
        body: [
    ...
    faqs: [
      { question: "Apakah semua operator besar tersedia?", answer: "Ya. SiKouta mendukung operator utama seperti Telkomsel, Indosat, XL, Axis, Smartfren, Tri, dan brand terkait yang aktif di katalog." },
  ...
  },
  {
    ...
    description: "Panduan membeli paket data harian, mingguan, dan bulanan melalui SiKouta dengan grup produk yang lebih jelas dan mudah dipilih.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Di SiKouta, grup produk dan judul kartu yang lebih ringkas membuat pembeli lebih cepat memahami isi paket seperti 1 GB 7 Hari atau 12 GB 30 Hari.",
        ],
      },
      {
  ...
  },
  {
    ...
    title: "Cara Top Up DANA, OVO, GoPay, dan LinkAja di SiKouta",
    description: "Panduan top up e-wallet melalui SiKouta, termasuk nominal tetap, bebas nominal, dan cara membaca biaya secara lebih jelas.",
  ...
  },
  {
    ...
    description: "Panduan top up game melalui SiKouta untuk pemain dan penjual, dengan alur yang lebih ringkas dan fokus ke produk inti.",
    ...
    sections: [
      ...
      {
        heading: "Cara top up game di SiKouta",
        body: [
  ...
  },
  {
    ...
    description: "Panduan membeli token listrik PLN melalui SiKouta, termasuk cara membaca grup promo, standar reply, dan full reply.",
  ...
  },
  {
    ...
    description: "Panduan membayar tagihan listrik atau PLN pascabayar melalui SiKouta dengan proses yang mudah dipahami pelanggan rumah tangga maupun agen PPOB.",
  ...
  },
  {
    ...
    description: "Panduan membayar BPJS Kesehatan online lewat SiKouta untuk kebutuhan pribadi, keluarga, dan layanan PPOB.",
    ...
    hero: "Kategori BPJS memperluas layanan SiKouta dari produk harian ke kebutuhan bulanan yang lebih wajib.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Layanan BPJS juga memperluas citra SiKouta dari top up harian menjadi platform pembayaran yang lebih lengkap.",
        ],
      },
      {
        heading: "Cara bayar BPJS di SiKouta",
        body: [
  ...
  },
  {
    ...
    description: "Panduan membayar tagihan PDAM secara online melalui SiKouta untuk pelanggan rumah tangga dan usaha PPOB.",
    ...
    hero: "Layanan PDAM membantu SiKouta menjangkau kebutuhan rumah tangga yang rutin dan sangat dekat dengan repeat order.",
  ...
  },
  {
    ...
    description: "Panduan membayar internet pascabayar secara online melalui SiKouta untuk kebutuhan pribadi, keluarga, dan bisnis PPOB.",
    ...
    hero: "Kategori internet pascabayar membantu SiKouta menjangkau kebutuhan digital rumah tangga yang terus tumbuh.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Kategori ini juga memperkuat citra SiKouta sebagai platform kebutuhan rumah tangga digital, bukan hanya top up harian.",
        ],
      },
      {
  ...
  },
  {
    ...
    description: "Panduan membayar tagihan HP pascabayar melalui SiKouta untuk pelanggan pribadi, agen, dan website PPOB.",
  ...
  },
  {
    ...
    description: "Panduan membeli voucher TV digital dan membayar layanan TV berlangganan melalui SiKouta untuk pelanggan rumah tangga dan agen PPOB.",
    ...
    hero: "Kategori TV membuat layanan rumah tangga di SiKouta terasa lebih lengkap dan lebih relevan untuk repeat order.",
  ...
  },
  {
    ...
    description: "Panduan memperpanjang masa aktif nomor HP melalui SiKouta agar nomor tetap aktif tanpa harus membeli produk yang tidak diperlukan.",
  ...
  },
  {
    ...
    description: "Panduan aktivasi perdana dan top up awal nomor baru lewat SiKouta untuk pengguna baru, agen, dan penjual starter pack.",
  ...
  },
  {
    ...
    description: "Panduan memulai usaha jualan pulsa dari rumah dengan produk awal yang tepat, langkah sederhana, dan arah tumbuh bersama SiKouta.",
  ...
  {
    slug: "cara-menjadi-agen-pulsa-di-sikouta",
    title: "Cara Menjadi Agen Pulsa di SiKouta",
    description: "Panduan menjadi agen SiKouta dari pendaftaran, pilihan produk awal, sampai cara membangun layanan yang rapi dan repeat order.",
    ...
    category: "Bisnis Agen",
    readTime: "7 menit",
    keywords: ["cara menjadi agen pulsa", "daftar agen pulsa", "agen sikouta", "reseller produk digital"],
    ...
    sections: [
      {
        ...
        body: [
          ...
          "SiKouta memberi fondasi yang baik karena kategori produk utama sudah tersedia dalam satu platform.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Dengan jalur seperti ini, agen tidak perlu pindah platform saat bisnis mulai tumbuh. SiKouta tetap bisa dipakai dari tahap awal sampai tahap usaha yang lebih serius.",
        ],
      },
    ],
    faqs: [
  ...
  {
    slug: "cara-menjadi-member-h2h-sikouta",
    title: "Cara Menjadi Member H2H SiKouta untuk Bisnis yang Lebih Besar",
    description: "Panduan menjadi member H2H SiKouta untuk website, aplikasi, atau panel reseller yang ingin transaksi lebih otomatis dan rapi.",
    ...
    category: "H2H",
    readTime: "8 menit",
    keywords: ["member h2h", "host to host pulsa", "api pulsa", "sikouta h2h"],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "SiKouta memberi jalur ini untuk member yang ingin bergerak dari layanan manual ke sistem yang lebih otomatis tanpa harus mengganti basis produk.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan membuat website jualan pulsa dengan halaman produk yang jelas, struktur layanan yang rapi, dan arah tumbuh ke H2H SiKouta.",
  ...
  {
    slug: "keuntungan-berlangganan-dan-bertumbuh-bersama-sikouta",
    title: "Keuntungan Berlangganan dan Bertumbuh Bersama SiKouta",
    description: "Keuntungan memakai SiKouta untuk agen, reseller, dan bisnis yang ingin tumbuh dari transaksi harian ke website atau H2H.",
    ...
    category: "Bisnis Agen",
    readTime: "6 menit",
    keywords: ["keuntungan sikouta", "platform jualan pulsa", "reseller produk digital", "agen sikouta"],
    hero: "SiKouta relevan bukan hanya untuk transaksi harian, tetapi juga untuk pertumbuhan bisnis jangka panjang.",
    ...
    sections: [
      {
        ...
        body: [
          "SiKouta tidak berhenti di satu kategori. Pulsa, paket data, e-wallet, token listrik, game, dan PPOB saling mendukung untuk membentuk layanan yang lebih lengkap.",
      ...
      },
      {
        ...
        body: [
          "Calon member biasanya ingin tahu apakah sebuah platform hanya cocok untuk transaksi kecil atau juga bisa dipakai untuk bertumbuh. SiKouta memberi jawaban lewat jalur yang jelas dari transaksi harian sampai integrasi yang lebih serius.",
    ...
    faqs: [
      { question: "Apa keuntungan utama SiKouta untuk agen?", answer: "Agen bisa menjual pulsa, paket data, e-wallet, token listrik, game, dan layanan rumah tangga tanpa pindah-pindah platform saat usaha mulai tumbuh." },
      { question: "Apakah SiKouta cocok untuk pemula dan bisnis bertumbuh?", answer: "Ya. Pemula bisa mulai dari pulsa, kuota, dan e-wallet, sementara bisnis yang lebih siap bisa naik ke website jualan dan H2H." },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Cara Beli Paket Telepon Semua Operator di SiKouta",
    description: "Panduan membeli paket telepon semua operator di SiKouta untuk pelanggan harian dan member yang ingin menambah layanan pelengkap.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Karena itu, kategori paket telepon tetap penting untuk membuat layanan SiKouta terasa lebih lengkap.",
        ],
      },
      {
        heading: "Cara membeli paket telepon di SiKouta",
        body: [
  ...
  },
  {
    ...
    title: "Cara Beli Pulsa Data dan Kombinasi Pulsa Kuota di SiKouta",
    description: "Panduan membeli pulsa data dan produk kombinasi pulsa-kuota di SiKouta untuk pelanggan yang butuh pilihan lebih fleksibel.",
    ...
    hero: "Pulsa data membantu SiKouta menjangkau kebutuhan operator yang tidak selalu pas jika hanya dibagi antara pulsa reguler dan paket data biasa.",
    ...
    sections: [
      {
        heading: "Apa itu pulsa data di SiKouta",
        body: [
      ...
      },
      {
        ...
        body: [
          "Pulsa data membantu SiKouta terlihat lebih lengkap karena mampu menutup celah antara pulsa reguler dan kuota biasa.",
  ...
  },
  {
    ...
    description: "Panduan membayar PGN online melalui SiKouta untuk pelanggan rumah tangga dan agen yang ingin layanan energinya lebih lengkap.",
    excerpt: "PGN adalah kategori yang membuat layanan rumah tangga di SiKouta terasa lebih lengkap bersama listrik, PDAM, dan internet pascabayar.",
    category: "PGN",
    readTime: "5 menit",
    keywords: ["bayar pgn online", "tagihan gas online", "pgn rumah tangga", "ppob pgn"],
    hero: "PGN memperluas layanan SiKouta ke kebutuhan energi rumah tangga yang lebih lengkap dan lebih bernilai untuk pelanggan bulanan.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Kategori seperti ini memberi kesan bahwa SiKouta bukan hanya platform top up, tetapi juga pusat pembayaran digital keluarga.",
        ],
      },
      {
        heading: "Cara bayar PGN di SiKouta",
        body: [
      ...
      },
      {
        ...
        body: [
          ...
          "Inilah salah satu masa depan SiKouta: tumbuh dari kebutuhan harian seperti pulsa dan kuota ke kebutuhan rumah tangga yang lebih menyeluruh.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    title: "Cara Top Up Saldo Member dengan QRIS dan Bank di SiKouta",
    description: "Panduan top up saldo member SiKouta lewat QRIS dan bank agar transaksi harian dan operasional agen tetap lancar.",
    ...
    category: "Deposit",
    readTime: "6 menit",
    keywords: ["top up saldo member", "deposit qris", "saldo sikouta", "isi saldo agen"],
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Karena itu, top up saldo bukan sekadar fitur tambahan, tetapi bagian inti dari operasional bisnis di SiKouta.",
        ],
      },
      {
        heading: "Cara top up saldo di SiKouta",
        body: [
  ...
  {
    slug: "perbedaan-member-retail-agen-dan-h2h-di-sikouta",
    title: "Perbedaan Member Retail, Agen, dan H2H di SiKouta",
    description: "Panduan memahami beda retail, agen, dan H2H di SiKouta agar calon member bisa memilih model usaha yang paling sesuai.",
    ...
    readTime: "7 menit",
    keywords: ["member retail", "agen pulsa", "h2h sikouta", "perbedaan retail agen h2h"],
    hero: "SiKouta bisa dipakai dari level transaksi harian sampai integrasi bisnis. Bedanya ada pada cara kerja, skala, dan kebutuhan operasionalnya.",
    products: ["Pulsa Telkomsel", "DANA", "Token Listrik Promo", "BPJS Kesehatan", "API H2H"],
    ctaLabel: "Lihat Jalur Retail, Agen, dan H2H",
    ctaHref: "/artikel/cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-sikouta",
    publishedAt,
    updatedAt,
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Dengan memahami perbedaan tiga model ini, calon member bisa merancang masa depan usahanya di SiKouta dengan lebih realistis.",
        ],
      },
    ],
    faqs: [
  ...
  {
    slug: "cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-sikouta",
    title: "Cara Bertumbuh dari Retail ke Agen dan H2H Bersama SiKouta",
    description: "Panduan bertahap untuk tumbuh dari retail ke agen lalu ke H2H di SiKouta tanpa kehilangan kendali operasional.",
    ...
    category: "Bisnis Agen",
    readTime: "8 menit",
    keywords: ["naik dari retail ke agen", "bertumbuh ke h2h", "masa depan usaha pulsa", "sikouta bisnis"],
    hero: "SiKouta paling bernilai ketika dipakai sebagai jalur pertumbuhan usaha, bukan hanya sebagai tempat transaksi harian.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Masa depan usaha bersama SiKouta adalah kemampuan untuk naik tahap tanpa harus mengganti fondasi produk yang sudah Anda bangun sejak awal.",
        ],
      },
    ],
    faqs: [
  ...
  {
    slug: "produk-sikouta-yang-paling-cocok-untuk-calon-member",
    title: "Produk SiKouta yang Paling Cocok untuk Calon Member",
    description: "Panduan memilih produk SiKouta untuk calon member, dari pulsa, paket data, e-wallet, game, listrik, sampai PPOB rumah tangga.",
    ...
    category: "Panduan Member",
    readTime: "8 menit",
    keywords: ["produk sikouta", "calon member sikouta", "produk paling laris", "usaha produk digital"],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Dengan jalur bertumbuh seperti ini, SiKouta tidak hanya membantu transaksi harian, tetapi juga perkembangan usaha jangka panjang.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan membangun warung pulsa dan PPOB dengan produk yang tepat, layanan rumah tangga yang lengkap, dan arah tumbuh bersama SiKouta.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Dari titik ini, SiKouta bisa dipakai bukan hanya untuk melayani warung harian, tetapi juga untuk menyiapkan langkah usaha yang lebih besar.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan menyusun katalog produk digital agar pembeli cepat paham, mudah memilih, dan lebih nyaman bertransaksi di layanan SiKouta Anda.",
  ...
  },
  {
    ...
    description: "Panduan mengelola pelanggan rutin untuk token listrik, BPJS, PDAM, dan tagihan rumah tangga agar repeat order lebih stabil di SiKouta.",
  ...
  {
    slug: "cara-membangun-panel-reseller-dengan-h2h-sikouta",
    title: "Cara Membangun Panel Reseller dengan H2H SiKouta",
    description: "Panduan membangun panel reseller dengan H2H SiKouta untuk bisnis yang ingin menerima order otomatis dan menata operasional lebih rapi.",
    ...
    category: "H2H",
    readTime: "8 menit",
    keywords: ["panel reseller", "h2h sikouta", "api panel pulsa", "reseller otomatis"],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "SiKouta cocok dipakai di tahap ini karena memberi jalur dari member biasa ke integrasi yang lebih serius tanpa mengganti fondasi produk.",
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "SiKouta cocok untuk pola seperti ini karena kategori rumah tangganya bisa melengkapi top up harian dalam satu layanan.",
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "SiKouta cocok untuk tahap ini karena bisa dipakai dari alur chat manual sampai ke jalur usaha yang lebih besar.",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Panduan memanfaatkan promo operator sambil tetap menjaga katalog produk rapi, mudah dipahami, dan nyaman dipakai pelanggan SiKouta.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "SiKouta mendukung pola ini karena member bisa memulai dari usaha kecil lalu menyesuaikan modal, produk, dan ritme transaksi secara bertahap.",
        ],
      },
    ],
    faqs: [
...
const productQuickLinkMap: Record<string, QuickLink> = {
  ...
  Agen: { label: "Panduan Menjadi Agen", href: "/artikel/cara-menjadi-agen-pulsa-di-sikouta" },
  H2H: { label: "Panduan Member H2H", href: "/artikel/cara-menjadi-member-h2h-sikouta" },
...
const relatedArticleMap: Record<string, string[]> = {
  ...
  "cara-top-up-ewallet-dana-ovo-gopay-linkaja": [
    ...
    "produk-sikouta-yang-paling-cocok-untuk-calon-member",
  ],
  "cara-top-up-game-mobile-legends-free-fire-pubg": [
    "cara-top-up-ewallet-dana-ovo-gopay-linkaja",
    "cara-beli-paket-data-harian-dan-bulanan",
  ...
  "cara-bayar-bpjs-kesehatan-online": [
    "cara-bayar-tagihan-listrik-online",
    "cara-bayar-pdam-online",
    "cara-menjadi-agen-pulsa-di-sikouta",
  ],
  "cara-bayar-pdam-online": [
    "cara-bayar-tagihan-listrik-online",
    "cara-bayar-bpjs-kesehatan-online",
  ...
  "cara-menjadi-member-h2h-sikouta": [
    "perbedaan-member-retail-agen-dan-h2h-di-sikouta",
    "cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-sikouta",
    "cara-membuat-website-jualan-pulsa-sendiri",
  ],
  "cara-membuat-website-jualan-pulsa-sendiri": [
    "cara-menjadi-agen-pulsa-di-sikouta",
    "cara-menjadi-member-h2h-sikouta",
    "cara-membangun-panel-reseller-dengan-h2h-sikouta",
  ],
  "keuntungan-berlangganan-dan-bertumbuh-bersama-sikouta": [
    "produk-sikouta-yang-paling-cocok-untuk-calon-member",
    "cara-bertumbuh-dari-retail-ke-agen-dan-h2h-bersama-sikouta",
