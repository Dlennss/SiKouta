...
SOURCE_DIR="${SOURCE_DIR:-/var/lib/syslog-ng/sikouta/sikouta-fe}"
RELEASE_ROOT="${RELEASE_ROOT:-/var/lib/syslog-ng/sikouta/releases/sikouta-fe}"
...
SERVICE_NAME="${FRONTEND_SERVICE_NAME:-sikouta-fe.service}"
